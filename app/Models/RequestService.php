...
class RequestService extends Model {
 protected $fillable = ['service_id','professional_fee','original_professional_fee','discount_type','discount_value','discount_amount','discount_reason','net_professional_fee','gst_rate','gst_amount','government_charges','government_charges_snapshot','final_total','pricing_locked_at','pricing_unlocked_at','pricing_unlocked_by','estimated_days','required_documents_snapshot','status','approved_at','rejected_at','decision_notes','decided_by'];
