...
class CommonRequiredDocumentsLibraryTest extends TestCase
{
    ...
    public function test_one_master_document_is_shared_by_every_service_with_independent_configuration(): void
    {
        ...
        $this->assertDatabaseHas('service_required_documents', ['service_id' => $second->id, 'common_required_document_id' => $configuration->common_required_document_id, 'is_mandatory' => false, 'is_active' => false]);
    }
