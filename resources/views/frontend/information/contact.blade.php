...
<section class="section-space information-page-body"><div class="container information-content-wide">
    ...
    <div class="row g-4 mt-2">
        ...
        <div class="col-md-6"><div class="public-contact-card h-100"><x-public-icon name="clock" size="26" /><span><small>Office Timings</small><strong>{{ !($pageData['officeStatus']['isOpen'] ?? false) ? 'આજે ઓફિસ બંધ છે' : ($pageData['workingHoursLabel'] ? str($pageData['workingHoursLabel'])->after('Working Hours: ') : 'ઓફિસનો કાર્ય સમય હાલમાં ઉપલબ્ધ નથી.') }}</strong></span></div></div>
    </div>
