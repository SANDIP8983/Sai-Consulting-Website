...
<section class="section-space service-detail-content"><div class="container"><div class="row g-5">
    <div class="col-lg-8">
        ...
        @if($service->notes)<section class="detail-section service-notes premium-card mt-4" aria-labelledby="service-notes-title"><i class="bi bi-info-circle" aria-hidden="true"></i><div><h2 id="service-notes-title">નોંધ <small>Service Notes</small></h2><p>{{ $service->notes }}</p></div></section>@endif
    </div>
