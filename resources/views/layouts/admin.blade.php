            ...
            <aside id="adminSidebar" class="admin-sidebar collapse d-lg-flex flex-column flex-shrink-0 bg-dark text-white">
                ...
                <div class="p-3 flex-grow-1">
                    <nav class="nav nav-pills flex-column gap-1" aria-label="Admin navigation">
                        ...
                        @can('services.manage')<a class="nav-link {{ request()->routeIs('admin.services.*') ? 'active' : '' }}" href="{{ route('admin.services.index') }}">Services</a><a class="nav-link {{ request()->routeIs('admin.government-charge-types.*') ? 'active' : '' }}" href="{{ route('admin.government-charge-types.index') }}">Government Charges</a>@endcan
